Over time your website gets wieldy so it needs cleanup.
Though its simple to find what modules are enabled/disabled, its rather
...
Notes / caveats
* Core modules are not listed, do never delete them!
